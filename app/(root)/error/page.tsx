...
function ErrorContent() {
  ...
  const errorConfig =
    errorType && ERROR_CONFIGS[errorType]
...
// Loading skeleton component for the error page
function ErrorLoadingSkeleton() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4 py-12 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          <div className="mx-auto h-16 w-16 rounded-full bg-destructive/10 flex items-center justify-center animate-pulse">
            <Skeleton className="h-10 w-10 rounded-full bg-destructive/20" />
          </div>

          <Skeleton className="mt-6 h-8 w-3/4 mx-auto bg-muted-foreground/20" />

          <Skeleton className="mt-2 h-4 w-full bg-muted-foreground/10" />
          <Skeleton className="mt-1 h-4 w-5/6 mx-auto bg-muted-foreground/10" />
        </div>
        ...
        <div className="mt-6 text-center">
          <Skeleton className="h-4 w-1/2 mx-auto bg-muted-foreground/10" />
        </div>
      </div>
    </div>
  );
