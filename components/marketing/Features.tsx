  ...
  return (
    <section className="flex flex-col gap-10 items-center text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
        ...
        <div
          ref={setFeatureRef(1)}
          className="flex flex-col gap-4 text-left p-6 bg-white/[0.05] border border-white/10 rounded-xl opacity-0 transition-all duration-700 ease-out hover:bg-white/[0.08] hover:border-white/20 hover:shadow-lg hover:shadow-primary/10 hover:-translate-y-1"
        >
        ...
        <div
          ref={setFeatureRef(3)}
          className="md:col-span-2 flex flex-col gap-4 text-left p-6 bg-white/[0.05] border border-white/10 rounded-xl opacity-0 transition-all duration-700 ease-out hover:bg-white/[0.08] hover:border-white/20 hover:shadow-lg hover:shadow-primary/10 hover:-translate-y-1"
        >
