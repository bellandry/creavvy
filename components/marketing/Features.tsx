    ...
    <section className="flex flex-col gap-10 items-center text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
        <div
          ...
          role="region"
          aria-labelledby="feature-0-title"
        >
          <h3 id="feature-0-title" className="text-white text-xl font-bold">
          ...
          <div
            ...
            aria-label="Aperçu de la personnalisation en temps réel"
          ></div>
        </div>
        <div
          ref={setFeatureRef(1)}
        ...
        >
          ...
          <div
            ...
            aria-label="Aperçu de l'import facile"
          ></div>
        </div>
        <div
          ref={setFeatureRef(2)}
        ...
        >
          <h3 id="feature-2-title" className="text-white text-xl font-bold">
          ...
          <div
            ...
            aria-label="Aperçu des templates prêts à l'emploi"
          ></div>
        </div>
        <div
          ref={setFeatureRef(3)}
        ...
        >
          ...
          <div
            ...
            aria-label="Aperçu de l'export haute qualité"
          ></div>
        </div>
      </div>
    </section>
