...
const Footer = () => {
  return (
    <footer className="w-full max-w-6xl px-4 lg:px-8 py-12 sm:py-16 border-t border-white/10">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-white text-xl font-bold">Snippet Studio</h2>
          </div>
          <p className="text-white/70 text-sm">
            Créez des visuels percutants pour votre contenu technique en quelques secondes.
          </p>
        </div>
        
        <div className="flex flex-col gap-4">
          <h3 className="text-white font-bold">Produit</h3>
        ...
        <div className="flex flex-col gap-4">
          <h3 className="text-white font-bold">Ressources</h3>
          <ul className="flex flex-col gap-3">
            <li>
              <a href="#" className="text-white/70 hover:text-white text-sm transition-colors">
                Documentation
        ...
        <div className="flex flex-col gap-4">
          <h3 className="text-white font-bold">Entreprise</h3>
          <ul className="flex flex-col gap-3">
            <li>
              <a href="#" className="text-white/70 hover:text-white text-sm transition-colors">
                À propos
      ...
      <div className="border-t border-white/10 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
        <p className="text-white/70 text-sm">
          © {new Date().getFullYear()} Snippet Studio. Tous droits réservés.
        </p>
